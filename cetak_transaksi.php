  ...
  body, page {
    ...
    box-shadow: 0;
        ...
        .container {
                  display: flex;
                  align-items: center;
                  justify-content: space-between; /* Buat jarak antar elemen di dalam kontainer */
        ...
        .container .info {
            ...
            margin-left: 20%; /* Sesuaikan sesuai kebutuhan */
            margin-right: 0;
        }
      ...
      <center>
        <div class="container">
          <div class="info">
            ...
            <span>
              Jl. Kol. Barlian No.167, Saung Naga, Baturaja Barat<br>
              Telp. +62-823-7743-1817 || E-mail violetadhira.29@gmail.com
            </span>
           </div>
            <div class="gambar">
